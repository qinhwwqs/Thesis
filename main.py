...
for i in model:
    ...
    for j in range(0,2):
        ...
        filter_channels = model[i][j][1]

        for k in range(1,5):
            a = "FD00" + str(k)
            
            model_path = "C:/Users/andre/Desktop/论文/media/inti/data/FINAL/" + a +"/"
